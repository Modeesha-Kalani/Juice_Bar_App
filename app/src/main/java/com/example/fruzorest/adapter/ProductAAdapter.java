...
import com.example.fruzorest.ViewProductsAdminActivity;
import com.example.fruzorest.model.ProductInfo;
import com.example.fruzorest.viewholder.ProductViewHolder;

import java.util.ArrayList;

public class ProductAAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ArrayList<ProductInfo> list;
    Context context;

    public ProductAAdapter(ArrayList<ProductInfo> plist) {
        this.list = plist;
    }

    @Override
    public void onClick(View v) {
        Intent i = new Intent(context, ViewProductsAdminActivity.class);
